...
namespace NikonCameraSettings.SequenceItems {
    ...
    [ExportMetadata("Name", "Set User Comment")]
    [ExportMetadata("Description", "Sets the user comment string embedded in image metadata.")]
    [ExportMetadata("Icon", "CameraSVG")]
    [ExportMetadata("Category", "Nikon Settings")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class SetUserComment : SequenceItem, IValidatable {
        ...
        public SetUserComment(ICameraMediator camera) {
            this.camera = camera;
        ...
        public override object Clone() {
            return new SetUserComment(this.camera) {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public bool Validate() {
            ...
            } else if (!theCam.SupportsCapability(eNkMAIDCapability.kNkMAIDCapability_UserComment)) {
