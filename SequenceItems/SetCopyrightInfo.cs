...
namespace NikonCameraSettings.SequenceItems {
    ...
    [ExportMetadata("Name", "Set Copyright Info")]
    [ExportMetadata("Description", "Sets the copyright string embedded in image metadata.")]
    [ExportMetadata("Icon", "CameraSVG")]
    [ExportMetadata("Category", "Nikon Settings")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class SetCopyrightInfo : SequenceItem, IValidatable {
        ...
        private string copyrightInfo = string.Empty;
        ...
        public SetCopyrightInfo(ICameraMediator camera) {
            this.camera = camera;
        ...
        public override object Clone() {
            return new SetCopyrightInfo(this.camera) {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public bool Validate() {
            ...
            } else if (!theCam.SupportsCapability(eNkMAIDCapability.kNkMAIDCapability_CopyrightInfo)) {
