...
namespace NikonCameraSettings.SequenceItems {
    ...
    [ExportMetadata("Name", "Set Shutter Sound")]
    [ExportMetadata("Description", "Sets the electronic shutter sound effect.")]
    ...
    public class SetShutterSound : SequenceItem, IValidatable {
        ...
        private static List<string> shutterSoundSettings = new List<string>();

        public List<string> ShutterSoundSettings {
            get => shutterSoundSettings;
            set {
                shutterSoundSettings = value;
                RaisePropertyChanged();
            }
        }

        private string selectedShutterSoundSetting;

        [JsonProperty]
        public string SelectedShutterSoundSetting {
            get => selectedShutterSoundSetting;
            set {
                selectedShutterSoundSetting = value;
                RaisePropertyChanged();
            }
        }
        ...
        public SetShutterSound(ICameraMediator camera) {
            this.camera = camera;
        ...
        private Task CameraDisconnected(object arg1, EventArgs args) {
            ShutterSoundSettings = new List<string>();
            return Task.CompletedTask;
        }

        public override object Clone() {
            return new SetShutterSound(this.camera) {
                Icon = Icon,
                Name = Name,
                Category = Category,
                Description = Description,
                ShutterSoundSettings = ShutterSoundSettings,
            };
        }
        ...
        public bool Validate() {
            ...
            } else if (!theCam.SupportsCapability(eNkMAIDCapability.kNkMAIDCapability_ShutterSoundEffect)) {
