...
namespace NikonCameraSettings.SequenceItems {
    ...
    [ExportMetadata("Name", "Set Noise Reduction")]
    [ExportMetadata("Description", "Sets the long-exposure noise reduction setting.")]
    ...
    public class SetNoiseReduction : SequenceItem, IValidatable {
        ...
        private static List<string> noiseReductionSettings = new List<string>();

        public List<string> NoiseReductionSettings {
            get => noiseReductionSettings;
            set {
                noiseReductionSettings = value;
                RaisePropertyChanged();
            }
        }

        private string selectedNoiseReductionSetting;

        [JsonProperty]
        public string SelectedNoiseReductionSetting {
            get => selectedNoiseReductionSetting;
            set {
                selectedNoiseReductionSetting = value;
                RaisePropertyChanged();
            }
        }
        ...
        public SetNoiseReduction(ICameraMediator camera) {
            this.camera = camera;
        ...
        private Task CameraDisconnected(object arg1, EventArgs args) {
            NoiseReductionSettings = new List<string>();
            return Task.CompletedTask;
        }

        public override object Clone() {
            return new SetNoiseReduction(this.camera) {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public bool Validate() {
            ...
            } else if (!theCam.SupportsCapability(eNkMAIDCapability.kNkMAIDCapability_NoiseReduction)) {
